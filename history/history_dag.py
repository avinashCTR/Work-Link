...
bash_command = textwrap.dedent(
		...
		--save_path "/data1/archive/avinash/GA_DATA_UPLOAD"
        """
)
...
PreProcessHistory = CoutureSparkOperator(
    ...
    input_base_dir_path=f"/data1/archive/avinash/GA_DATA_UPLOAD/{datetime.now().strftime('%Y-%m-%d')}/",
    output_base_dir_path="/data1/archive/avinash/HistoryDataTest",
...
NormalizeQueryHistoryData = CoutureSparkOperator(
    ...
    input_base_dir_path="/data1/archive/avinash/HistoryDataTest",
    output_base_dir_path="/data1/archive/avinash/HistoryDataTest",
...
GroupSearchQueries = CoutureSparkOperator(
    ...
    output_filenames_dict={"queries_with_frequencies": "QueriesWithFrequencies/queriesWithFrequencies",
						   "query_impressions_with_frequencies": "QueryImpressionsWithFrequencies/queryImpressionsWithFrequencies",
                           "query_clicks_with_frequencies": "QueryClicksWithFrequencies/queryClicksWithFrequencies"},
    dag=Dag,
