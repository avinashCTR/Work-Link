...
python_egg = "couture_search-2.0.7-py3.13.egg"#"couture_search-2.0.3-py3.13.egg"
python_egg_avinash_old = "avinash_couture_search-2.0.7-py3.9.egg"
python_egg_avinash = "avinash_couture_search-2.0.7-py3.12.egg"
...
TopNStepWiseOutput = CouturePythonDockerOperator(
    ...
    method_args_dict={"n": query_count_all,
                      ...
                      "verticals_list":['groceries', 'beauty', 'electronics', 'home_lifestyle', 'other_verticals', 'fashion']},
    volumes=[searchEngineVolume],
    input_base_dir_path="",#dirPathProcessed + "AnalysisCorpusJSON/",
    output_base_dir_path="",
    input_filenames_dict={
                          ...
                          "all_queries_path":"/data1/archive/avinash/guardrails/gtCleanedExploadedVerticalCollectedVerticalMapped --- final.csv",
                          ...
                          "base_path":"/data1/searchengine/processed/jiomart/05092024/V10_next_best_frac_changes/UnifiedCorpus/",
                          "r2syn_path": "/analysis/Wrong2RightWordsAnalysisCSVR2X/part-00000-3b31c7b6-4770-4bc0-815f-b5bf6b0929fc-c000.csv",#/part-00000-df500549-b303-42b0-bef0-2640162b6f61-c000.csv",
                          "r2sub_path": "/AnalysisCorpusJSON/r2sub.json",
                          "w2r_path": "/analysis/Wrong2RightWordsAnalysisCSVW2R/part-00000-a051ca81-2e88-45c1-a5cb-4bd0702af537-c000.csv",#/part-00000-00ad8f2c-cd34-4127-947d-d72460ac2eab-c000.csv",
                          "r2e_path": "/JSONData/RightWordEntitiesCSV/part-00000-fc44f3b9-cf25-40f5-9b8d-9f2b23141948-c000.csv",#/part-00000-b75c014e-0f9c-47ec-b600-4e9781d73ce3-c000.csv",
                          ...
                          "phrase_corpus_path": "/JSONData/InternalPhraseCSV/part-00000-138d5cc3-8a25-4afa-9f29-fe62a2e9f39e-c000.csv",#/part-00000-759c4edc-3e6b-4a7b-9956-174f04d6d660-c000.csv",
    ...
    output_filenames_dict={
      ...
      #                      "topN_step_wise_path" : "topn_parquet"},
      						"month_data_out": dirPathFinalOutput+"run_"+str_date+"/top_"+str(query_count_all)+"_stepwise_output_V9.csv",#"_stepwise_output_top3.csv",
...
AnalyseTopN = CouturePythonDockerOperator(
    task_id='AnalyseTopN',
    image=python_image,
    api_version='auto',
    auto_remove=False,
    ...
    dag=dag,
    code_artifact=code_artifact_python,
    python_deps=[commons_egg,python_egg_avinash], #python_egg],
    method_id='analyse_topn_step_wise',
    method_args_dict={},
    volumes=[searchEngineVolume],
    input_base_dir_path=dirPathFinalOutput+"run_"+str_date+"/",
    output_base_dir_path=dirPathFinalOutput+"AnalyseTopN/V10_next_best_frac_changes/",
    input_filenames_dict={"top_n_stepwise": "top_"+str(query_count_all)+"_stepwise_output_V9.csv"},
    output_filenames_dict={
      "empty_queries": "empty_queried.csv",
      "query_level":"query_level.csv",
      "query_vertical_level":"query_vertical.csv",
      "metrics_text":"metrics.txt"
    },
    description=''
)
AnalyseTopN.set_upstream([TopNStepWiseOutput])
